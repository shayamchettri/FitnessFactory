...
<div className=" max-w-[80%] mx-auto bg-white my-6 font-[sans-serif] text-[#011c2b]">
            <div className="text-center px-6">
                ...
                <p className="text-lg text-gray-500  mt-3">Feel free to send us your queries.</p>
            </div>
            <div className="grid lg:grid-cols-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8">
                <div className="bg-[#011c2b] rounded-lg p-6 max-lg:text-center">
                    ...
                    <p className="text-sm text-gray-400 mt-3">Our contacts</p>
                    <ul className="mt-16 space-y-10">
                        <li className="flex items-center max-lg:justify-center">
                            ...
                            <a href="" className="text-white text-sm ml-3">
                                <strong>finessfactoryktm2016@gmail.com</strong>
                            </a>
                        </li>
                        <li className="flex items-center max-lg:justify-center">
                        ...
                        <li className="flex items-center max-lg:justify-center">
                            ...
                            <a href="" className="text-white text-sm ml-3">
                                <strong>Hattigauda Complex, Budhanilkantha Kathmandu, Nepal 44600</strong>
                            </a>
                        </li>
                    </ul>
